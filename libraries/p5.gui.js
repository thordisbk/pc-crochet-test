// https://github.com/bitcraftlab/p5.gui/blob/master/libraries/p5.gui.js
...
(function() {
    ...
    function QSGui(label, parent, sketch) {
      ...
      // --- self
      this.addCheckBoxWithCallback = function(title, value, callback) {
        qs.addBoolean(title, value, callback);
      }
      // ---
